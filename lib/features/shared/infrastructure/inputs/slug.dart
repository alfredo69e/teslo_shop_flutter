...
class Slug extends FormzInput<String, SlugError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == SlugError.format ) return 'El Campo no tiene el formato deseado';
  ...
  SlugError? validator(String value) {
    ...
    if ( value.toString().isEmpty || value.toString().trim().isEmpty ) return SlugError.empty;
